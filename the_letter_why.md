...
###Joshua, son of (a) *Nun*
*Son of a gun*, is that a reference to the *Virgin* Mother in a convent, or does it actually mean "none?"  I'll have you know, none of the real life candidates for *Mary* are even close to as perfect as they think they are--not Melissa, not Nanna, and not *Jan*et.  In *Jan*uary, I'll tell you R.Y.
