...
Right in front of us is a commentary on our civilization; some criticism, some suggestions, and some praise.  God's wisdom is given to us in the process of revealing that ancient scripture and stories are not only related to us, but about us.  The story of Exodus is the apocalypse, and the life of Christ revealed to be paralleled in both the Old and New Testaments are about a modern man.  By seeing that the entirety of the Bible contains a hidden prophesy, one that is an old story about another time at face value; we gain not only insight from its message, but a parallel of how that message expands into our world.  It too has another meaning at face value, the author's "original intent."  Like Orwell's *doublespeak*, many of our modern films and songs relate to the Bible and to each other in such a way that there is no other explanation than a hidden hand subtly influencing us.

The message comes from the future, and understanding that the sender(s) view our civilization in much the same way as we view Biblical 
