...
We can begin to see the message by understanding the perspective of the authors.  They often see our civlization in the same way that we view that of the ancient Egyptians or Romans.  To them, we use antiquated tools, like we view stone weapons; and many of our cultural conventions are sadly inadequate to provide the freedom and safety that they know we deserve.  
