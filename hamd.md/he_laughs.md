...
This transliteration is untraditional, but it is an accurate representation of how the Jewish dish "sounds."  There is no doubt, once you understand that it links the names of my contemporary family members through time all the way to ancient Egypt and Bethlehem that it's intent is to show that the Passover and Easter holidays are link to now.  Charoset, haroset, or charoses (Hebrew: חֲרֽוֹסֶת [ḥărōset])
